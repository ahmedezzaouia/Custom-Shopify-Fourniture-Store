...
it’s a Complete Shopify Store 2.0 built with Liquid, CSS, and Javascript, Fully Responsive on all Screens sizes With the help of CSS media query, every page you will see is built from scratch and hardcoded

Website : https://lnkd.in/dprjm9BW \
password : 1
